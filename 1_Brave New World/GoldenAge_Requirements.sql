...
INSERT OR REPLACE INTO RequirementSetRequirements (RequirementSetId,							RequirementId)
SELECT	'GOLDEN_CITY_HAS_WORSHIP_BUILDING_REQUIREMENTS',		'GOLDEN_REQUIRES_CITY_HAS_WORSHIP_BUILDING' ||BuildingType FROM Buildings WHERE EnabledByReligion = 1;
INSERT OR REPLACE INTO Requirements (RequirementId,									RequirementType)
SELECT	'GOLDEN_REQUIRES_CITY_HAS_WORSHIP_BUILDING' ||BuildingType,	'REQUIREMENT_CITY_HAS_BUILDING' FROM Buildings WHERE EnabledByReligion = 1;
INSERT OR REPLACE INTO RequirementArguments (RequirementId,									Name,			Value)
SELECT	'GOLDEN_REQUIRES_CITY_HAS_WORSHIP_BUILDING' ||BuildingType,	'BuildingType',	BuildingType FROM Buildings WHERE EnabledByReligion = 1;

INSERT OR REPLACE INTO RequirementSets (RequirementSetId,						RequirementSetType)
VALUES	('GOLDEN_CITY_HAS_NO_WORSHIP_BUILDING_REQUIREMENTS',	'REQUIREMENTSET_TEST_ALL');
INSERT OR REPLACE INTO RequirementSetRequirements (RequirementSetId,							RequirementId)
SELECT	'GOLDEN_CITY_HAS_NO_WORSHIP_BUILDING_REQUIREMENTS',		'GOLDEN_REQUIRES_CITY_HAS_NO_WORSHIP_BUILDING' ||BuildingType FROM Buildings WHERE EnabledByReligion = 1;
INSERT OR REPLACE INTO Requirements (RequirementId,									RequirementType,			        Inverse)
SELECT	'GOLDEN_REQUIRES_CITY_HAS_NO_WORSHIP_BUILDING' ||BuildingType,	'REQUIREMENT_CITY_HAS_BUILDING', 1 FROM Buildings WHERE EnabledByReligion = 1;
INSERT OR REPLACE INTO RequirementArguments (RequirementId,									Name,			Value)
SELECT	'GOLDEN_REQUIRES_CITY_HAS_NO_WORSHIP_BUILDING' ||BuildingType,	'BuildingType',	BuildingType FROM Buildings WHERE EnabledByReligion = 1;
--工业区T1-3
INSERT OR REPLACE INTO RequirementSets (RequirementSetId,						RequirementSetType) VALUES	
