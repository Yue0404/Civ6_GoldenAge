...
INSERT OR REPLACE INTO GreatPersonIndividualActionModifiers (GreatPersonIndividualType, 			ModifierId, AttachmentTargetType) VALUES	
('GREAT_PERSON_INDIVIDUAL_CHARLES_DARWIN',	       		'GOLDEN_GREATPERSON_ADJACENT_NATURALWONDER_CULTURE',        'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_UNIT_GREATPERSON');
INSERT OR REPLACE INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, SubjectRequirementSetId) VALUES	
('GOLDEN_GREATPERSON_ADJACENT_NATURALWONDER_CULTURE',     			'MODIFIER_PLAYER_UNIT_GRANT_ADJACENT_NATURAL_WONDER_YIELD',  		1, 1, NULL);
INSERT OR REPLACE INTO ModifierArguments (ModifierId,			Name,		        Value) VALUES
('GOLDEN_GREATPERSON_ADJACENT_NATURALWONDER_CULTURE',			'YieldType',	    'YIELD_CULTURE');
INSERT OR REPLACE INTO ModifierArguments (ModifierId,			Name,		        Value, 		Type) VALUES
('GOLDEN_GREATPERSON_ADJACENT_NATURALWONDER_CULTURE',			'Amount',	    	1000,		'ScaleByGameSpeed');
