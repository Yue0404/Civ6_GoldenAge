...
local UV_CITIZEN_GROWTH_STATUS		:table	= {};
		UV_CITIZEN_GROWTH_STATUS[0] = {u=0, v=0};     -- HAPPINESS_HELL
		UV_CITIZEN_GROWTH_STATUS[1] = {u=0, v=0};     -- HAPPINESS_REVOLT
        UV_CITIZEN_GROWTH_STATUS[2] = {u=0, v=0};     -- HAPPINESS_UNREST
        UV_CITIZEN_GROWTH_STATUS[3] = {u=0, v=0};     -- HAPPINESS_FURIOUS
		UV_CITIZEN_GROWTH_STATUS[4] = {u=0, v=0};     -- HAPPINESS_UNHAPPY
        UV_CITIZEN_GROWTH_STATUS[5] = {u=0, v=50};     -- HAPPINESS_DISPLEASED
        UV_CITIZEN_GROWTH_STATUS[6] = {u=0, v=100};     -- HAPPINESS_CONTENT
		UV_CITIZEN_GROWTH_STATUS[7] = {u=0, v=150};     -- HAPPINESS_HAPPY
        UV_CITIZEN_GROWTH_STATUS[8] = {u=0, v=200};     -- HAPPINESS_JOYOUS
        UV_CITIZEN_GROWTH_STATUS[9] = {u=0, v=250};     -- HAPPINESS_ELATED
        UV_CITIZEN_GROWTH_STATUS[10] = {u=0, v=300};    -- HAPPINESS_ECSTATIC
        UV_CITIZEN_GROWTH_STATUS[11] = {u=0, v=350};  -- HAPPINESS_UTOPIC
		UV_CITIZEN_GROWTH_STATUS[12] = {u=0, v=400};  -- HAPPINESS_HEAVEN
