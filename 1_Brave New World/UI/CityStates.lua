...
function GetBonusText( playerID:number, envoyTokenNum:number )
	...
	elseif (leader == "LEADER_MINOR_CIV_CSE_AGRICULTURAL" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_CSE_AGRICULTURAL") then
		if envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FIRST_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_AGRICULTURAL_TRAIT_SMALL_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_SECOND_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_AGRICULTURAL_TRAIT_MEDIUM_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_THIRD_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_AGRICULTURAL_TRAIT_LARGE_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_AGRICULTURAL_TRAIT_LARGEST_INFLUENCE_BONUS");--Food
		else UI.DataError("Unknown envoy number for city-state type bonus: " .. tostring(envoyTokenNum));
		end
	elseif (leader == "LEADER_MINOR_CIV_CSE_CONSULAR" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_CSE_CONSULAR") then
		if envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FIRST_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_CONSULAR_TRAIT_SMALL_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_SECOND_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_CONSULAR_TRAIT_MEDIUM_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_THIRD_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_CONSULAR_TRAIT_LARGE_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_CONSULAR_TRAIT_LARGEST_INFLUENCE_BONUS");--Influence
		else UI.DataError("Unknown envoy number for city-state type bonus: " .. tostring(envoyTokenNum));
		end
	elseif (leader == "LEADER_MINOR_CIV_CSE_ENTERTAINMENT" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_CSE_ENTERTAINMENT") then
		if envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FIRST_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_ENTERTAINMENT_TRAIT_SMALL_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_SECOND_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_ENTERTAINMENT_TRAIT_MEDIUM_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_THIRD_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_ENTERTAINMENT_TRAIT_LARGE_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_ENTERTAINMENT_TRAIT_LARGEST_INFLUENCE_BONUS");--Entertainment
		else UI.DataError("Unknown envoy number for city-state type bonus: " .. tostring(envoyTokenNum));
		end
	elseif (leader == "LEADER_MINOR_CIV_CSE_MARITIME" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_CSE_MARITIME") then
		if envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FIRST_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_MARITIME_TRAIT_SMALL_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_SECOND_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_MARITIME_TRAIT_MEDIUM_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_THIRD_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_MARITIME_TRAIT_LARGE_INFLUENCE_BONUS");
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS then bonusDetailsText = Locale.Lookup("LOC_CSE_MARITIME_TRAIT_LARGEST_INFLUENCE_BONUS");--Gold
		else UI.DataError("Unknown envoy number for city-state type bonus: " .. tostring(envoyTokenNum));
		end
	else
...
function GetBonusIconAtlasPieces( kCityState:table, size:number )	
	local sTestCityType = kCityState.Type;
	...
	--CIVITAS City-States Expanded
	elseif kCityState.Type == "AGRICULTURAL"	then	iconName = "ICON_ENVOY_BONUS_CSE_AGRICULTURAL";
	elseif kCityState.Type == "CONSULAR"		then	iconName = "ICON_ENVOY_BONUS_CSE_ENTERTAINMENT";	
	elseif kCityState.Type == "ENTERTAINMENT"	then	iconName = "ICON_ENVOY_BONUS_CSE_CONSULAR";
	elseif kCityState.Type == "MARITIME"		then	iconName = "ICON_ENVOY_BONUS_CSE_MARITIME";
	end
...
function GetTypeTooltip( kCityState:table )
	...
	--CIVITAS City-States Expanded
	elseif kCityState.Type == "AGRICULTURAL"	then	toolTip = "LOC_CITY_STATES_TYPE_CSE_AGRICULTURAL";
	elseif kCityState.Type == "CONSULAR"		then	toolTip = "LOC_CITY_STATES_TYPE_CSE_CONSULAR";	
	elseif kCityState.Type == "ENTERTAINMENT"	then	toolTip = "LOC_CITY_STATES_TYPE_CSE_ENTERTAINMENT";
	elseif kCityState.Type == "MARITIME"		then	toolTip = "LOC_CITY_STATES_TYPE_CSE_MARITIME";
	else
...
function GetTypeAtlasPieces( kCityState:table, size:number )
	...
	--CIVITAS City-States Expanded
	elseif kCityState.Type == "AGRICULTURAL"	then	iconName = "ICON_CITYSTATE_CSE_AGRICULTURAL";
	elseif kCityState.Type == "CONSULAR"		then	iconName = "ICON_CITYSTATE_CSE_CONSULAR";	
	elseif kCityState.Type == "ENTERTAINMENT"	then	iconName = "ICON_CITYSTATE_CSE_ENTERTAINMENT";	
	elseif kCityState.Type == "MARITIME"		then	iconName = "ICON_CITYSTATE_CSE_MARITIME";
	else
...
function GetTypeName( kCityState:table )		
	local sCityType = kCityState.Type;
	...
	--CIVITAS City-States Expanded
	elseif kCityState.Type == "AGRICULTURAL"	then	return Locale.Lookup("LOC_CITY_STATES_TYPE_CSE_AGRICULTURAL");
	elseif kCityState.Type == "CONSULAR"		then	return Locale.Lookup("LOC_CITY_STATES_TYPE_CSE_CONSULAR");
	elseif kCityState.Type == "ENTERTAINMENT"	then	return Locale.Lookup("LOC_CITY_STATES_TYPE_CSE_ENTERTAINMENT");
	elseif kCityState.Type == "MARITIME"		then	return Locale.Lookup("LOC_CITY_STATES_TYPE_CSE_MARITIME");
	end
...
function GetCityStateType( playerID:number )
	...
	elseif (leader == "LEADER_MINOR_CIV_CSE_CONSULAR" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_CSE_CONSULAR") then
		cityStateType = "CONSULAR";
	elseif (leader == "LEADER_MINOR_CIV_CSE_ENTERTAINMENT" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_CSE_ENTERTAINMENT") then
		cityStateType = "ENTERTAINMENT";
	elseif (leader == "LEADER_MINOR_CIV_CSE_MARITIME" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_CSE_MARITIME") then
