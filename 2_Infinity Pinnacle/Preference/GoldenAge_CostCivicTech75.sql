...
UPDATE Eras SET GreatPersonBaseCost = GreatPersonBaseCost*0.75;

UPDATE Eras_XP1 SET GameEraMaximumTurns = GameEraMaximumTurns*0.75, GameEraMinimumTurns = GameEraMinimumTurns*0.75;

UPDATE Maps_XP2 SET CO2For1DegreeTempRise = CO2For1DegreeTempRise*0.75;
